...
class FixedWidthToParquetConverter:
    def __init__(self, input_file, output_file, fields, chunk_size=10000):
        ...
        with open(self.input_file) as file:
            while True:
                try:
                    ...
                    chunk = pd.read_fwf(file, widths=column_widths, names=column_names, nrows=self.chunk_size,
                                        dtype=str,
...
class ConfigLoader:
    ...
    def from_yaml(config_file):
        with open(config_file, 'r') as file:
            ...
            return input_file, output_file, fields, chunk_size
...
def main():
    ...
    if args.config_file:
        ...
        input_file, output_file, fields, chunk_size = ConfigLoader.from_yaml(args.config_file)
    elif args.input_file and args.output_file and args.column_names and args.column_widths and args.column_types:
        # Load parameters from command-line arguments
        input_file, output_file, fields, chunk_size = ConfigLoader.from_args(args)
    else:
    ...
    converter = FixedWidthToParquetConverter(input_file, output_file, fields, chunk_size)
    converter.convert()
